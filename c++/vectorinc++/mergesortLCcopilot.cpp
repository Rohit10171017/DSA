...
{
  // Merge from the end to avoid overwriting elements in a[]
  int i = n - m - 1; // Last valid element in a[]
  int j = m - 1;     // Last element in b[]
  int k = n - 1;     // Last position in merged array
  ...
  // No need to copy remaining a[] elements, as they are already in place
}
